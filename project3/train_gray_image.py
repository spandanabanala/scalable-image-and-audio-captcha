...
class ImageSequence(keras.utils.Sequence):
    ...
    def __getitem__(self, idx):
        ...
        for i in range(self.batch_size):
            ...
            raw_data = cv2.imread(os.path.join(self.directory_name, random_image_file), 0)
            processed_data = numpy.array(raw_data) / 255.0
            processed_data = numpy.reshape(processed_data, (self.captcha_height, self.captcha_width, -1))
            X[i] = processed_data
